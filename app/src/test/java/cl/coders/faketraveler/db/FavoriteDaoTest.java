...
public class FavoriteDaoTest {
    ...
    @Test public void insert_then_get_returns_entry() {
        ...
        List<FavoriteEntity> all = dao.getAllSync();
    ...
    @Test public void delete_removes_entry() {
        ...
        e.createdAt = 1L;
        dao.insert(e);
        FavoriteEntity stored = dao.getAllSync().get(0);
        dao.delete(stored);
        assertEquals(0, dao.getAllSync().size());
    }

    @Test public void ordered_by_createdAt_desc() {
        FavoriteEntity a = new FavoriteEntity();
        a.name = "A"; a.createdAt = 100L;
        FavoriteEntity b = new FavoriteEntity();
